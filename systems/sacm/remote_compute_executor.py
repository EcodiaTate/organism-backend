"""
EcodiaOS — SACM Remote Compute Executor

Axon-compatible executor that bridges action execution to the SACM pipeline.

This module is separate from service.py to avoid circular import:
  - axon.executors imports sacm.service (for SACMClient)
  - sacm.service imports axon.executor (for base Executor class)
  - This module imports both, breaking the cycle
"""
...
class RemoteComputeExecutor(Executor):
    ...
    def __init__(self, sacm_client: SACMClient) -> None:
        ...
        self._log = logger.bind(component="sacm.remote_compute_executor")
